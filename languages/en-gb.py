...
'The synchronization module allows the synchronization of data resources between Code For Africa instances.': 'The synchronisation module allows the synchronisation of data resources between Code For Africa instances.',
